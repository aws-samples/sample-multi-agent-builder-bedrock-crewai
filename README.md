...
1. **🖥️ Frontend Interface** - Users interact with a React-based web interface hosted on Amazon S3 and distributed via Amazon CloudFront. The UI provides no-code creation and management of agents, missions, and tasks.
...
### 1️⃣ AWS Connection Setup & Context File Creation
...
**🏗️ Bootstrap AWS Environment** *(first-time setup)*
```bash
cdk bootstrap
```
...
**⏱️ Pipeline Deployment** *(~15 minutes)*  
